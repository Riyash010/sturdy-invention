// Sample SCP data - in real app, this would be generated from HTML files
export const scpData = {
  2: {
    ...
    image: "./public/images/scp-002-1.jpg",
    addendums: [
      "Addendum 002-1: Testing shows that the bell's effect is auditory-based."
    ]
  },
  3: {
    itemNumber: "SCP-003",
    ...
    image: "./public/images/scp-003-1.jpg",
    addendums: []
  },
  4: {
    itemNumber: "SCP-004",
    ...
    image: "./public/images/scp-004-1.jpg",
    addendums: [
      "Addendum 004-1: Configuration Alpha causes time dilation."
    ]
  },
  5: {
    itemNumber: "SCP-005",
    ...
    image: "./public/images/scp-005-1.jpg",
    addendums: []
  },
  6: {
    itemNumber: "SCP-006",
    ...
    image: "./public/images/scp-006-1.jpg",
    addendums: [
      "Addendum 006-1: Water from SCP-006 has been used in medical trials."
    ]
  }
};